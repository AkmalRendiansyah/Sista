...
class NilaiPenguji3Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $nilaisidang = nilaipenguji3::where('id_penguji3', $dosens->id)
        ->orderBy('id', 'asc')
        ->get();
        $dosen = v_dosen::orderBy('name', 'asc')->get();
       
       
        return view('dosen.nilaipenguji3.index', compact('nilaisidang', 'dosen'));
    }
    ...
    {
        return view('dosen.nilaipenguji3.edit',['nilai'=>nilaipenguji3::find($id)]);
    }
    ...
    $validated['komentar'] = $request->komentar;
        ...
        nilaipenguji3::where('id',$id)->update($validated);
