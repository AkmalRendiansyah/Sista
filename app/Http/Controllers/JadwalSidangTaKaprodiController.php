...
class JadwalSidangTaKaprodiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $penguji = v_dosen::OrderBy('name', 'asc')->get();
         ...
         return view('kaprodi.jadwalsidang.index',compact('jadwalta', 'ruang','mahasiswa','mulaisesi','selesaisesi','pembimbing1','pembimbing2','penguji'));
    ...
    public function create()
    {
        ...
        return view('kaprodi.jadwalsidang.create', [
            'dosens' => $dosens,
            'ruangs' => $ruangs,
            'sesis' => $sesis,
            'sidangtas' => $sidangtas,
...
if ($penguji3Exists) {
    ...
    public function edit(string $id)
    {
        ...
        $mahasiswas = v_mahasiswa::all();
        return view('kaprodi.jadwalsidang.edit', [
            'dosens' => $dosens,
            'ruangs' => $ruangs,
            'sesis' => $sesis,
            'sidangtas' => $sidangtas,
...
if ($penguji3Exists) {
    ...
    // }
        ...
        return redirect('jadwal-ta-kaprodi')->with('pesan', 'Data berhasil diupdate');
    }
    public function destroy(string $id)
    {
        ...
        return redirect('jadwal-ta-kaprodi')->with('pesan','Data berhasil terhapus');
    }
}
