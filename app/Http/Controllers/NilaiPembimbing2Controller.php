...
class NilaiPembimbing2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $nilaisidang = nilaipembimbing2::where('id_pembimbing2', $dosens->id)
        ->orderBy('id', 'asc')
        ->get();
        $dosen = v_dosen::orderBy('name', 'asc')->get();

        return view('dosen.nilaipembimbing2.index', compact('nilaisidang', 'dosen'));
    }
    ...
    {
        return view('dosen.nilaipembimbing2.edit',['nilai'=>nilaipembimbing2::find($id)]);
    }
    ...
    $validated['komentar'] = $request->komentar;
        ...
        nilaipembimbing2::where('id',$id)->update($validated);
        return view('dosen.nilaipembimbing2.edit',['nilai'=>nilaipembimbing2::find($id)]);
    }
