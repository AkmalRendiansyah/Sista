...
class NilaiPenguji2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $nilaisidang = nilaipenguji2::where('id_penguji2', $dosens->id)
        ->orderBy('id', 'asc')
        ->get();
        $dosen = v_dosen::orderBy('name', 'asc')->get();
       
       
        return view('dosen.nilaipenguji2.index', compact('nilaisidang', 'dosen'));
    }
    ...
    {
        return view('dosen.nilaipenguji2.edit',['nilai'=>nilaipenguji2::find($id)]);
    }
    ...
    $validated['komentar'] = $request->komentar;
        ...
        nilaipenguji2::where('id',$id)->update($validated);
