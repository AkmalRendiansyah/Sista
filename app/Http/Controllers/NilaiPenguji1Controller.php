...
class NilaiPenguji1Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $nilaisidang = nilaipenguji1::where('id_penguji1', $dosens->id)
        ->orderBy('id', 'asc')
        ->get();
        $dosen = v_dosen::orderBy('name', 'asc')->get();
       
       
        return view('dosen.nilaipenguji1.index', compact('nilaisidang', 'dosen'));
    }
    ...
    {
        return view('dosen.nilaipenguji1.edit',['nilai'=>nilaipenguji1::find($id)]);
    }
    ...
    $validated['komentar'] = $request->komentar;
        ...
        nilaipenguji1::where('id',$id)->update($validated);
