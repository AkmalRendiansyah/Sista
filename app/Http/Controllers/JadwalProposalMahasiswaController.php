...
class JadwalProposalMahasiswaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $jadwalproposal = jadwalproposal::where('id_mahasiswa', $mahasiswa->id)
        ->orderBy('id', 'asc')
        ->get();
        

         return view('mahasiswa.jadwalproposal.index',compact('jadwalproposal', 'ruang','mahasiswa','mulaisesi','selesaisesi','pembimbing1','pembimbing2','penguji'));
    }
