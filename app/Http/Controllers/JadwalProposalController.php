...
class JadwalProposalController extends Controller
{
    ...
    public function index()
    {
        ...
        $penguji = v_dosen::OrderBy('name', 'asc')->get();
         ...
         return view('admin.jadwalproposal.index',compact('jadwalproposal', 'ruang','mahasiswa','mulaisesi','selesaisesi','pembimbing1','pembimbing2','penguji'));
    ...
    public function create()
    {
        ...
        return view('admin.jadwalproposal.create', [
            'dosens' => $dosens,
            'ruangs' => $ruangs,
            'sesis' => $sesis,
...
if ($datasama > 0) {
    // Redirect atau response lain jika data sudah ada
    return redirect('/jadwal-proposal')->with('error', 'Jadwal proposal untuk tanggal, ruang, dan sesi tersebut sudah ada.');
}
        
        jadwalproposal::create($data);

       
                return redirect('/jadwal-proposal');
    }
    ...
    public function edit(string $id)
    {
        ...
        $mahasiswas = v_mahasiswa::all();
        return view('admin.jadwalproposal.edit', [
            'dosens' => $dosens,
            'ruangs' => $ruangs,
            'sesis' => $sesis,
            'proposaltas' => $proposals,
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('jadwal-proposal')->with('pesan', 'Data berhasil diupdate');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('jadwal-proposal')->with('pesan','Data berhasil terhapus');
    }
}
