...
<main>
    ...
    <a href="/sesi-ta-kaprodi/create" class="btn btn-primary mb-3">Create sesi</a> 
    <table class="table table-boreder table-striped">
        ...
        <tr>
            ...
            <td>{{$sesis->selesai}}</td>
            <td>
                <a href="/sesi-ta-kaprodi/{{$sesis->id}}/edit" class="btn btn-success btn-sm">Edit</a>
                {{-- <a href="" class="btn btn-danger btn-sm">Hapus</a> --}}
                <form action="sesi-ta-kaprodi/{{$sesis->id}}" method="post" class="d-inline">
                    @method('DELETE')
                    @csrf
