        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @if ( $sidang->mahasiswa)
                    <a href="{{ route('nilai.total.kaprodi', ['id' => $sidang->mahasiswa]) }}" class="btn btn-link">Lihat Nilai Keseluruhan</a>
                    @endif 
                    <br>
                ...
                <td>
                    @foreach ($nilaipem1 as $sidang2)
                        @if ($sidang2->mahasiswa == $sidang->mahasiswa)
                            <a href="{{ route('nilai.pem1.kaprodi', ['id' => $sidang2->id]) }}" class="btn btn-link">Lihat Nilai Pembimbing 1</a>
                        @endif
                    @endforeach
                </td>
                <td>
                    @foreach ($nilaipem2 as $sidang2)
                        @if ($sidang2->mahasiswa == $sidang->mahasiswa)
                            <a href="{{ route('nilai.pem2.kaprodi', ['id' => $sidang2->id]) }}" class="btn btn-link">Lihat Nilai Pembimbing 2</a>
                        @endif
                    @endforeach
                </td>
                <td>
                    @foreach ($nilaiketua as $sidang2)
                        @if ($sidang2->mahasiswa == $sidang->mahasiswa)
                            <a href="{{ route('nilai.ketua.kaprodi', ['id' => $sidang2->id]) }}" class="btn btn-link">Lihat Nilai ketua sidang</a>
                        @endif
                    @endforeach
                </td>
                <td>
                    @foreach ($nilaipenguji1 as $sidang2)
                        @if ($sidang2->mahasiswa == $sidang->mahasiswa)
                            <a href="{{ route('nilai.penguji1.kaprodi', ['id' => $sidang2->id]) }}" class="btn btn-link">Lihat Nilai Penguji 1</a>
                        @endif
                    @endforeach
                </td>
                <td>
                    @foreach ($nilaipenguji2 as $sidang2)
                        @if ($sidang2->mahasiswa == $sidang->mahasiswa)
                            <a href="{{ route('nilai.penguji2.kaprodi', ['id' => $sidang2->id]) }}" class="btn btn-link">Lihat Nilai Penguji 2</a>
                        @endif
                    @endforeach
                </td>
                <td>
                    @foreach ($nilaipenguji3 as $sidang2)
                        @if ($sidang2->mahasiswa == $sidang->mahasiswa)
                            <a href="{{ route('nilai.penguji3.kaprodi', ['id' => $sidang2->id]) }}" class="btn btn-link">Lihat Nilai Penguji 3</a>
                        @endif
                    @endforeach
                </td>
            </tr>
