...
<form action="/dashboard-dosen-kaprodi" method="POST">
    @csrf
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="dosen" readonly>
      @error('role')
          <div class="invalid-feedback">
            {{$message}}
          </div>
    ...
    <div class="mb-3">
        ...
        <a href="/dashboard-dosen-kaprodi" class="btn btn-success btn-sm">Back</a>
    </div>
