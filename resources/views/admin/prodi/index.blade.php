...
<main>
    ...
    <a href="/prodi/create" class="btn btn-primary mb-3">Create prodi</a> 
    <table class="table table-boreder table-striped">
        ...
        <tr>
            ...
            <td>
                <a href="/prodi/{{$prod->id}}/edit" class="btn btn-success btn-sm">Edit</a>
                {{-- <a href="" class="btn btn-danger btn-sm">Hapus</a> --}}
                <form action="prodi/{{$prod->id}}" method="post" class="d-inline">
                    @method('DELETE')
                    @csrf
