...
<main>
    ...
    <a href="/ruang/create" class="btn btn-primary mb-3">Create Ruang</a> 
    <table class="table table-boreder table-striped">
        ...
        <tr>
            ...
            <td>{{$ruangg->ruang}}</td>
            <td>
                <a href="/ruang/{{$ruangg->id}}/edit" class="btn btn-success btn-sm">Edit</a>
                {{-- <a href="" class="btn btn-danger btn-sm">Hapus</a> --}}
                <form action="ruang/{{$ruangg->id}}" method="post" class="d-inline">
                    @method('DELETE')
                    @csrf
