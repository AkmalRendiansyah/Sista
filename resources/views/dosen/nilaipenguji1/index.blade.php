...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Penguji 1 Sidang Ta</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active"> semua data Penguji 1 sidang Ta</li>
        </ol>
    </div>
    ...
    <table class="table table-boreder table-striped">
        ...
        <tr>
            ...
            <td>{{$sidang->total}}</td>
            <td><a href ="/nilai-penguji1-sidang-ta/{{$sidang->id}}/edit"><button class="btn btn-link">Beri Nilai Mahasiswa</button></a></td>
        </tr>
        @endforeach
{{--             
            <th>Etika dan</th>
