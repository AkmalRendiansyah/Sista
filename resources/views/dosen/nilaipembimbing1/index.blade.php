...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Nilai Pembimbing 1 Sidang Ta</h1>
    ...
    <table class="table table-boreder table-striped">
        ...
        <tr>
            ...
            <td>{{$sidang->pembimbing1->name}}</td>
            <td>{{$sidang->total}}</td>
            <td><a href ="/nilai-pembimbing1-sidang-ta/{{$sidang->id}}/edit"><button class="btn btn-link">Beri Nilai Mahasiswa</button></a></td>
        </tr>
        @endforeach
{{--             
            <th>Etika dan</th>
