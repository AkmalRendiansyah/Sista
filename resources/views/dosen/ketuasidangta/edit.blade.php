...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Ketua Sidang</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Edit</li>
        </ol>
    </div>

    <form action="/ketua-sidang-ta/{{$sidang->id}}" method="POST">
        @method('PUT')
        @csrf
        <div class="mb-2">
        ...
        <div class="mb-2">
          ...
          <input type="text" class="form-control @error('komentar') is-invalid @enderror" name="komentar" value="{{old('komentar',$sidang->komentar)}}" >
          @error('komentar')
              <div class="invalid-feedback">
                {{$message}}
              </div>
