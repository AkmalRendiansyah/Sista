...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Penguji 3 Sidang</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Edit</li>
        </ol>
    </div>

    <form action="/nilai-penguji3-sidang-ta/{{$nilai->id}}" method="POST">
        @method('PUT')
        @csrf
        ...
        <div class="d-flex justify-content-center mb-3">
            ...
            <a href="/nilai-penguji3-sidang-ta" class="btn btn-danger w-25 no-underline">Back</a>
