...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Penguji 3 Sidang Ta</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active"> semua data Penguji 3 sidang Ta</li>
        </ol>
    </div>
    ...
    <table class="table table-boreder table-striped">
        ...
        <tr>
            ...
            <td>{{$sidang->penguji3->name}}</td>
            <td>{{$sidang->total}}</td>
            <td><a href ="/nilai-penguji3-sidang-ta/{{$sidang->id}}/edit"><button class="btn btn-link">Beri Nilai Mahasiswa</button></a></td>
        </tr>
        @endforeach
{{--             
            <th>Etika dan</th>
